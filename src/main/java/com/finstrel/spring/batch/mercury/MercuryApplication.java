package com.finstrel.spring.batch.mercury;

import com.finstrel.spring.batch.mercury.entity.Aircraft;
import com.finstrel.spring.batch.mercury.step.AircraftItemProcessor;
import com.finstrel.spring.batch.mercury.step.AircraftItemReader;
import com.finstrel.spring.batch.mercury.step.AircraftItemWriter;
...
public class MercuryApplication {
  ...
  @Bean("aircraftStep")
  public Step buildAircraftStep(AircraftItemReader aircraftItemReader, AircraftItemProcessor aircraftItemProcessor, AircraftItemWriter aircraftItemWriter) {
